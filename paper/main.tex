...
91.3\%). Regression beats the published single-TTLC SOTA on MAE
(0.287 vs 0.298 for LCR) \todo{re-run with an RMSE-aware objective before
comparing to the internal-reference Transformers on RMSE (they are competitive,
especially LCL)}. Removing the turn-signal channels drops classification
