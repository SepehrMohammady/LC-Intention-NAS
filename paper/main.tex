...
reports a single time-to-lane-change regression (RMSE 0.51~s, Transformer);
the three-task formulation numbers are internal reference results on the same
prepared data. \todo{fill our rows from logs/experiments.jsonl; add params,
flash, RAM, MACs columns; confirm internal-baseline provenance with the
team.}}
\centering
\begin{tabular}{lccc}
\toprule
...
Published Transformer \cite{lcintention2026} & --- & \multicolumn{2}{c}{0.51 (single TTLC)} \\
