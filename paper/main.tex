...
($92.1\% \rightarrow 92.2\%$; LCR MAE $0.287 \rightarrow 0.286$), but ST Edge AI
does not support it \todo{cite ST doc/community}, so we report it as an
offline bound rather than a deployed configuration.
